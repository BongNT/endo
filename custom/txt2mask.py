...
def main():
    ...
    parser.add_argument("--dataset_root", type=str, default="/home/bongmedai/Endo/datasets/medai_endo_data", help="Root path of the dataset")
    parser.add_argument("--output_dir", type=str, default="masks_converted", help="Output directory name (created inside dataset root or absolute)")
