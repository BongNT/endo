...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--labels_dir",
        type=str,
        default="/home/bongmedai/Endo/ultralytics/runs/segment/val8/labels",
        help="Path to labels directory",
    )
    parser.add_argument(
        "--images_dir",
        type=str,
        default="/home/bongmedai/Endo/datasets/medai_endo_data/images/val",
        help="Path to images directory",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/home/bongmedai/Endo/ultralytics/runs/segment/val8/vis",
